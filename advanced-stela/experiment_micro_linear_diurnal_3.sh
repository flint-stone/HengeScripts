...
a=0
	...
	sudo bin/storm jar ~/storm-starter-0*.jar storm.starter.LinearTopology_3_diurnal_lexu linear remote
	sudo bin/storm jar ~/storm-starter-0*.jar storm.starter.DiamondTopology_3_lexu diamond remote
	sleep 240m
